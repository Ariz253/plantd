...
with home:
    ...
    with col1:
        st.markdown(
            ...
            <div class="card">
                <h3>📸 Upload</h3>
                <p>Upload a clear and sharp photo of the plant leaf to allow for accurate and instant detection of the disease.</p>
            </div>
            """,
            unsafe_allow_html=True,
        )
    ...
    with col3:
        st.markdown(
            ...
            <div class="card">
                <h3>💡 Solutions</h3>
                <p>Get clear, actionable prevention tips and effective treatment guidance to fight and prevent the diseases.</p>
            </div>
            """,
            unsafe_allow_html=True,
        )
